...
class Privacy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.transparent, // شفاف ليتناسق مع الخلفية المتدرجة
        elevation: 0,
        centerTitle: true,
        leading: Padding(
      ...
      body: Container(
        ...
        // 🎨 نفس التدرج اللوني الناعم الفاخر لتوحيد هوية شاشات التعريف بالمتجر
        ...
        child: GetBuilder<InformationController>(
          ...
          initState: (state) => Get.find<InformationController>().fetchPrivacy(), // جلب بيانات الخصوصية
          builder: (controller) {

            // ⏳ 1. حالة التحميل: الشيمر المتطور المخصص المتناسق مع أبعاد الكارت
            if (controller.isPrivacyLoading) {
              return _buildAdvancedShimmer();
            }

            final content = controller.privacyContent ;
            if (content.isEmpty) {
              return  Center(
                child: StoreText(value: "No privacy policy available",
                  color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 18.sp,),
              );
            }

            // ✅ 2. حالة النجاح: عرض كارت الخصوصية والأمان العائم
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    // 🔒 هالة ضوئية مخصصة لدرع الخصوصية والأمان
                    Container(
                      ...
                      child: Container(
                        ...
                        child: Icon(
                          Icons.gpp_good_outlined, // أيقونة درع الأمان الموثوق
                    ...
                    // 📜 كارت المحتوى العائم الفاخر (Floating Glass Card) لحماية وقراءة نصوص الخصوصية
                    Container(
                      width: double.infinity,
                      ...
                      child: Html(
                        ...
                        style: {
                          ...
                          "p": Style(
                            ...
                            color: const Color(0xff53575A), // خط مريح جداً للقراءة المتواصلة للبنود
                          ...
                          "h2": Style(
                            color: AppColor.mainColor, // تلوين بنود الاتفاقية الرئيسية بلون المتجر
  ...
  // 🛠️ شيمر متطور لصفحة الخصوصية يطابق تماماً حجم وانحناءات الهيكل الجديد
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Container(
              width: double.infinity,
              height: 350.h, // كارت أطول يحاكي نصوص سياسة الخصوصية
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.circular(24).r,
              ),
